        ...
        {data.map((item, i) => (
          <SwiperSlide key={i}>
            <div className='brand-logo'>
              <img className='img-grey-hover' src={`assets/imgs/banner/${item.img}`} alt='' />
            </div>
          </SwiperSlide>
        ))}
      </Swiper>

      <div className='slider-arrow slider-arrow-2 carausel-6-columns-arrow' id='carausel-6-columns-3-arrows'>
