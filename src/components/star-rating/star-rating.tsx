  ...
  return (
    <div className={styles['rating']}>
      ...
      <input
        ...
        onChange={(e) => setRate(Number(e.target.value))}
      />
      <label htmlFor={`rating-${name}-1`} />
      <div className={styles['emoji-wrapper']}>
        <div
          className={styles['emoji']}
          style={{
            transform: `translateY(-${100 * rate}px)`,
          }}
        >
          <svg className={styles['rating-0']} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
