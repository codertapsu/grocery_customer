        ...
        <article className='wow fadeIn animated hover-up mb-30' key={i}>
          ...
          <div className='entry-content-2'>
            ...
            <p className='post-exerpt mb-30'>
              These people envy me for having a lifestyle they don’t have, but the truth is, sometimes I envy their
              lifestyle instead. Struggling to sell one multi-million dollar home currently.
            </p>
