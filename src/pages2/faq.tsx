      ...
      <div>
        <div className='page-content'>
          <div className='container'>
            <h2 className='title mb-3 text-center'>Shipping Information</h2>
            <div className='accordion accordion-rounded' id='accordion-1'>
              <div className='card card-box card-sm bg-light'>
                ...
                <div id='collapse-1' className='collapse show' aria-labelledby='heading-1' data-parent='#accordion-1'>
                  <div className='card-body'>
                    ...
                    consectetuer ligula vulputate sem tristique cursus. Nam nulla quam, gravida non, commodo a, sodales
                    sit amet, nisi.
                  </div>
                </div>
              </div>
              <div className='card card-box card-sm bg-light'>
                ...
                <div id='collapse-2' className='collapse' aria-labelledby='heading-2' data-parent='#accordion-1'>
                  <div className='card-body'>
                    Ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam
                    malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.
                    Donec nec justo eget felis facilisis fermentum.Lorem ipsum dolor sit amet, consectetuer adipiscing
              ...
              <div className='card card-box card-sm bg-light'>
                ...
                <div id='collapse-3' className='collapse' aria-labelledby='heading-3' data-parent='#accordion-1'>
                  <div className='card-body'>
                    ...
                    adipiscing elit. Donec odio. Quisque volutpat mattis eros. Lorem ipsum dolor sit amet, consectetuer
            ...
            <h2 className='title mb-3 text-center'>Orders and Returns</h2>
            ...
            <h2 className='title mb-3 text-center'>Payments</h2>
