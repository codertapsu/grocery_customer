          ...
          <div className='container'>
            <div className='row'>
              <div className='col-lg-5 mx-auto text-center'>
                <h1 className='title heading-1 style-3 mb-40'>
                  Start an online retail business with <span className='text-brand'>Nest</span> today
                </h1>
                <p className='font-xl mb-80'>
                  Sell your products and accept credit card payments from buying customers. Shopify gives you everything
              ...
              <div className='col-xl-8 col-lg-12 mx-auto'>
                <div className='single-content mb-50'>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla modi dolores neque omnis ipsa? Quia,
                    nam voluptas! Aut, magnam molestias:
                  </p>
                  <ul className='mb-30'>
                    <li>Name (required)</li>
                    <li>Age (required)</li>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit officia necessitatibus repellat
                    placeat aut enim recusandae assumenda adipisci quisquam, deserunt iure veritatis cupiditate modi
                    aspernatur accusantium, mollitia doloribus. Velit, iste.
                  </p>
                  <h3>3. Add your products</h3>
                  <p>
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero ut autem sed! Assumenda, nostrum
                    non doloribus tenetur, pariatur veritatis harum natus ipsam maiores dolorem repudiandae laboriosam,
                    cupiditate odio earum eum?
                  </p>
                  <h3>4. Start selling</h3>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam nesciunt nam aut magnam libero
                    aspernatur eaque praesentium? Tempore labore quis neque? Magni.
                  </p>
