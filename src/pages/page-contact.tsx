...
const Gmap = dynamic(() => import('../components/elements/Gmap').then((m) => m.Gmap), { ssr: false });
              ...
              <div className='col-xl-10 col-lg-12 m-auto'>
                <section className='row align-items-end mb-50'>
                  <div className='col-lg-4 mb-lg-0 mb-md-5 mb-sm-5'>
                    <h4 className='text-brand mb-20'>How can help you ?</h4>
                  ...
                  <div className='col-lg-8'>
                    <div className='row'>
                      ...
                      <div className='col-lg-6 mb-lg-0 mb-4'>
                        <h5 className='text-brand mb-20'>03. Billing Inquiries</h5>
                        <p>
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec
                          ullamcorper mattis, pulvinar dapibus leo.
                        </p>
                ...
                <section className='mb-50'>
                  <div className='row mb-60'>
                    <div className='col-md-4 mb-md-0 mb-4'>
                      ...
                      <br />
                      <a className='btn btn-sm font-weight-bold border-radius-5 btn-shadow-brand hover-up mt-20 text-white'>
