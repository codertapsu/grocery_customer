              ...
              <section className='row align-items-center mb-50'>
                <div className='row mb-50 align-items-center'>
                  ...
                  <div className='col-lg-5'>
                    ...
                    <p>
                      Pitatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia
                ...
                <div className='row'>
                  <div className='col-lg-4 pr-30 mb-md-5 mb-lg-0 mb-sm-5'>
                    ...
                    <p>
                      Volutpat diam ut venenatis tellus in metus. Nec dui nunc mattis enim ut tellus eros donec ac odio
                        ...
                        <div className='team-card'>
                          ...
                          <div className='content text-center'>
                            ...
                            <div className='social-network mt-20'>
                              <a href='#'>
                                <img src='/assets/imgs/theme/icons/icon-facebook-brand.svg' alt='' />
                              </a>
                              <a href='#'>
                                <img src='/assets/imgs/theme/icons/icon-twitter-brand.svg' alt='' />
                              </a>
                              <a href='#'>
                                <img src='/assets/imgs/theme/icons/icon-instagram-brand.svg' alt='' />
                              </a>
                              <a href='#'>
                                <img src='/assets/imgs/theme/icons/icon-youtube-brand.svg' alt='' />
                              </a>
                            </div>
                          </div>
                        </div>
