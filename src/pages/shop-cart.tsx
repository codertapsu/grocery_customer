            ...
            <div className='row'>
              <div className='col-lg-8'>
                <div className='table-responsive shopping-summery'>
                  ...
                  <table className={cartItems.length > 0 ? 'table-wishlist table' : 'd-none'}>
                    <thead>
                ...
                <div className='row mb-50'>
                    ...
                    <form className='field_form shipping_calculator'>
                      ...
                      <div className='form-row row'>
                        <div className='form-group col-lg-6'>
                          <input required={true} placeholder='State / Country' name='name' type='text' />
                        </div>
                        <div className='form-group col-lg-6'>
                          <input required={true} placeholder='PostCode / ZIP' name='name' type='text' />
                        </div>
                      </div>
                      <div className='form-row'>
                        <div className='form-group col-lg-12'>
                  ...
                  <div className='col-lg-6 col-md-12'>
                    <div className='p-md-4 p-30 border-radius cart-totals border'>
                      <div className='heading_s1 mb-3'>
                        <h4>Cart Totals</h4>
                      </div>
